...
// 
// Date:         2021-07-03 11:25:21
// Tool:         carbon 1.0
// Arguments: :  --z3Exe /usr/bin/z3 --boogieExe /bin/boogie/Binaries/boogie --print ../../clean/carbon/tests/test.bpl /home/nick/Nextcloud/ETH/6th_semester/bachelor_thesis/carbon_fork/clean/carbon/tests/wildcards_slow.vpr
// Dependencies:
  ...
  modifies Heap, Mask;
{
  ...
  // -- Translating statement: inhale acc(x.f, wildcard) -- wildcards_slow.vpr@5.11--7.5
    havoc wildcard;
    perm := wildcard;
    assume x != null;
  ...
  // -- Translating statement: exhale acc(x.f, wildcard) -- wildcards_slow.vpr@7.11--7.12
    // Phase 3: all remaining permissions (containing read permissions, but in a negative context)
    perm := NoPerm;
    havoc wildcard;
    perm := perm + wildcard;
    assert {:msg "  Exhale might fail. There might be insufficient permission to access x.f (wildcards_slow.vpr@7.11--7.12) [4]"}
      Mask[x, f_6] > NoPerm;
  ...
  // -- Translating statement: v := x.f -- wildcards_slow.vpr@9.8--10.1
    
    // -- Check definedness of x.f
      assert {:msg "  Assignment might fail. There might be insufficient permission to access x.f (wildcards_slow.vpr@9.8--10.1) [5]"}
